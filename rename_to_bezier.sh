#!/bin/bash
cd /home/jude/ego-planner-bezier/src/planner

# 1. 修改 bezier_opt/include/bezier_opt/piecewise_bezier.h
cat > bezier_opt/include/bezier_opt/piecewise_bezier.h << 'HEADER'
...
echo "Created piecewise_bezier.h"
